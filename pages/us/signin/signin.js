...
Page({
  ...
  RefreshData(){
    ...
    this.getSigninlog(this.data.cur_year, this.data.cur_month)
  },
  getUserinfo() {
    app.auth_request({
      url: 'user/info'
  ...
  getSigninlog(cur_year, cur_month){
    wx.showLoading({})
    app.auth_request({
      url: "signinlog",
      params:{
  ...
  */
  onShareAppMessage: function (res) {
    ...
    return {
      title: "邀请好友送魔豆",
      desc: '邀请好友每日拿豆',
      imageUrl: "https://gzch.oss-cn-beijing.aliyuncs.com/office/image/%E9%82%80%E8%AF%B7%E5%A5%BD%E5%8F%8B1.png",
